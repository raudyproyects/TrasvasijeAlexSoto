...
class EntregasControllerTest < ActionController::TestCase
  ...
  test "should create entrega" do
    assert_difference('Entrega.count') do
      post :create, entrega: { cantidad: @entrega.cantidad, cliente_id: @entrega.cliente_id, fecha: @entrega.fecha, materia_id: @entrega.materia_id }
    end
  ...
  test "should update entrega" do
    patch :update, id: @entrega, entrega: { cantidad: @entrega.cantidad, cliente_id: @entrega.cliente_id, fecha: @entrega.fecha, materia_id: @entrega.materia_id }
    assert_redirected_to entrega_path(assigns(:entrega))
  end
